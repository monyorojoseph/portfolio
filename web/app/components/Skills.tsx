...
import { Code, Database, Server, Layout, GitBranch, Terminal, Layers, Cpu, Globe, Workflow, Cloud } from "lucide-react"
...
const skills = [
  ...
  },
  {
    ...
    description: "Developing secure and scalable server-side applications with clean architecture principles and RESTful APIs.",
  ...
  },
  {
    ...
    description: "Designing and optimizing database schemas, writing efficient queries, and implementing data security best practices.",
    color: "text-purple-500",
  },
  {
    icon: Layout,
    name: "Caching and Messaging Queue",
    tech: "Redis, RabbitMQ",
    description: "Implementing caching strategies and message queues to enhance application performance and enable asynchronous processing.",
    color: "text-pink-500",
  },
  {
    icon: GitBranch,
  ...
  },
  {
    icon: Layers,
    name: "Devops",
    tech: "Azure DevOps, Gitlab CI",
    description: "Implementing CI/CD pipelines and automation for seamless development and deployment workflows.",
    color: "text-indigo-500",
  },
  {
    icon: Cpu,
    name: "API Development",
    tech: "Rest framework, grpc, FastAPI",
    description: "Designing and building RESTful and gRPC APIs with comprehensive documentation and robust error handling.",
    color: "text-red-500",
  },
]
