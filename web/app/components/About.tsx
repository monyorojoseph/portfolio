        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
              As a software engineer, I specialize in building web applications using Python, Django, TypeScript and Next.js.
              With a strong foundation in backend development and modern frontend frameworks, I create seamless full-stack
              solutions that deliver exceptional user experiences.
            </p>
            <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed">
              My expertise extends to Azure Cloud infrastructure and DevOps practices. I'm passionate about creating useful
              solutions for real problems while maintaining clean, efficient code and following industry best practices
              to deliver scalable and maintainable applications.
            </p>
          </motion.div>
          <motion.div
